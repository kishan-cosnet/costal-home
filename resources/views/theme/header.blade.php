...
<div class="page-header">
    <div class="header-wrapper row m-0">
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="{{ asset('images/logo/logo-1.png') }}" alt=""><img class="img-fluid for-dark" src="{{ asset('images/logo/logo.png') }}" alt=""></a></div>
            <div class="toggle-sidebar">
                <svg class="sidebar-toggle">
                    <use href="{{ asset('svg/icon-sprite.svg#stroke-animation') }}"></use>
                </svg>
            </div>
        </div>
                            ...
                            <div class="Typeahead Typeahead--twitterUsers">
                                <div class="u-posRelative d-flex">
                                    <svg class="search-bg svg-color me-2">
                                        <use href="{{ asset('svg/icon-sprite.svg#fill-search') }}"></use>
                                    </svg>
            ...
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown">
                    <div class="notification-box">
                        <svg>
                            <use href="{{ asset('svg/icon-sprite.svg#fill-Bell') }}"></use>
                    ...
                    <div class="onhover-show-div notification-dropdown">
                        ...
                        <div class="d-flex align-items-center figma-line"><img src="{{ asset('images/dashboard/user/7.png') }}" alt="">
                            <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                ...
                <!-- <li class="onhover-dropdown">
                    <svg>
                        <use href="{{ asset('svg/icon-sprite.svg#fill-star') }}"></use>
                    </svg>
                ...
                <!-- <li>
                    <div class="mode">
                        <svg>
                            <use href="{{ asset('svg/icon-sprite.svg#fill-dark') }}"></use>
                        </svg>
                    </div>
                </li> -->
                <li class="onhover-dropdown">
                    <div class="message">
                        <svg>
                            <use href="{{ asset('svg/icon-sprite.svg#fill-message') }}"></use>
                ...
                <!-- <li class="cart-nav onhover-dropdown">
                    <div class="cart-box">
                        <svg>
                            <use href="{{ asset('svg/icon-sprite.svg#fill-Buy') }}"></use>
                        </svg>
                    </div>
                    <div class="cart-dropdown onhover-show-div">
                        ...
                        <ul>
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 img-60" src="{{ asset('images/ecommerce/06.jpg') }}" alt="">
                            ...
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 img-60" src="{{ asset('images/ecommerce/02.jpg') }}" alt="">
                ...
                <li class="profile-nav onhover-dropdown p-0">
                    <div class="d-flex align-items-center profile-media"><img class="b-r-10 img-40" src="{{ asset('images/dashboard/profile.png') }}" alt="">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        ...
                        <li><a href="{{ route('signout') }}"><i data-feather="log-in"> </i><span>signout</span></a></li>
                    </ul>
                </li>
            </ul>
        </div>
